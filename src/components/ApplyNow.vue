  ...
  <div class="apply-now">
    <div class="sub-nav">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="productType==3 ||productType==4 || productType==5?{ path: '/creditloan' }:{ path: '/mortgageloan' }">{{productType==3 ||productType==4 || productType==5?'信用贷':'抵押贷'}}</el-breadcrumb-item>
        <el-breadcrumb-item>{{productType==1?'房抵贷':productType==3?'保单贷':productType==4?'月供带':productType==5?'工薪贷':'车抵贷'}}</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="content">
      <div class="left">
    ...
    <!-- 弹框 -->
    <el-dialog :visible.sync="dialogFormVisible" width="862px" class="detail-dialog">
      <template slot="title" class="head-dialog">
        <div class="bg">
          <div class="sub-title">
            30秒极速申请
          </div>
          <ul>
            <li>*若符合条件，贷款顾问将会在工作时间，2小时内和您联系，请保持电话通畅。</li>
            <li>*请尽量填写准确信息，确保贷款顾问能更精准推荐产品给您。</li>
          </ul>
        </div>
      </template>
      <div class="title">
